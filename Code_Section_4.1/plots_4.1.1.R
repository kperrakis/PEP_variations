...
results_normal <- dget('results_independent_normal.txt')
results_laplace <- dget('results_independent_laplace.txt')
results_a_normal <- dget('results_independent_a-normal.txt')
results_h_normal <- dget('results_independent_h-normal.txt')

source('reset.R')
library(vcd)

# -------------------------------------------------
# Figure 4 - boxplots of true probs
# -------------------------------------------------
...
# -------------------------------------------------
# Figure 5 - boxplots of incl probs for each X
# -------------------------------------------------

filename <- paste('ex1_inc_probs_normal.eps',sep = '')
...
# -------------------------------------------------
# Figure C.1 - boxplots of incl probs for each X
# -------------------------------------------------

filename <- paste('ex1_inc_probs_laplace.eps',sep = '')
postscript(filename,  horizontal = FALSE)
nmethods <- 5
...
# -------------------------------------------------
# Figure C.2 - boxplots of incl probs for each X
# -------------------------------------------------

filename <- paste('ex1_inc_probs_a_normal.eps',sep = '')
postscript(filename,  horizontal = FALSE)
nmethods <- 5
...
# -------------------------------------------------
# Figure C.3 - boxplots of incl probs for each X
# -------------------------------------------------

filename <- paste('ex1_inc_probs_h_normal.eps',sep = '')
postscript(filename,  horizontal = FALSE)
nmethods <- 5
